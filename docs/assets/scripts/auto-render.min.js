    ...
    return function() {
        ...
        var d = function(e, t) {
            ...
            -1 !== n; ) {
                ...
                if (n = l(t[o].right, e, t[o].left.length),
                -1 === n)
                    break;
        ...
        const c = function(e, t) {
            ...
            for (let e = 0; e < n.length; e++)
                if ("text" === n[e].type)
                    ...
                    try {
                        t.preProcess && (i = t.preProcess(i)),
                        a().render(i, o, t)
                    } catch (o) {
                        if (!(o instanceof a().ParseError))
                            throw o;
                        t.errorCallback("KaTeX auto-render: Failed to parse `" + n[e].data + "` with ", o),
        ...
        var p = function(e, t) {
            ...
            n.ignoredTags = n.ignoredTags || ["script", "noscript", "style", "textarea", "pre", "code", "option"],
